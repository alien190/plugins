...
public class DartMessenger {
    private static final String TAG = DartMessenger.class.getSimpleName();
    @NonNull
    ...
    public void finish(MethodChannel.Result result, Object payload) {
        handler.post(() -> {
            try {
                ...
                Log.e(TAG, "Finish event sending error: " + exception.toString());
            }
        });
    }
    ...
    public void error(
        ...
        handler.post(() -> {
            try {
                ...
                Log.e(TAG, "Error event sending error: " + exception.toString());
            }
        });
    }
}
